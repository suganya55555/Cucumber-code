...
@Smoke
  Scenario Outline: Verify user can able to book the hotel with valid credentials
    ...
    Examples: 
      ...
      | suganyasugan    | Suganya90   | London   | Hotel Creek | Standard     | 2 - Two   | 3 - Three | 1 - One   | Suganya   | R        | Chennai | 1236547890123654 | Master Card      | May     |    2022 | 2425 |
      | edwinraj        | edwin@123   | London   | Hotel Creek | Double       | 2 - Two   | 3 - Three | 1 - One   | Suganya   | R        | Chennai | 1236547890123654 | Master Card      | May     |    2022 | 2425 |
      | priyadharshiniM | priyasuji   | London   | Hotel Creek | Deluxe       | 2 - Two   | 3 - Three | 1 - One   | Suganya   | R        | Chennai | 1236547890123654 | Master Card      | May     |    2022 | 2425 |
      | Abhimanyuu      | Password01  | London   | Hotel Creek | Super Deluxe | 2 - Two   | 3 - Three | 1 - One   | Suganya   | R        | Chennai | 1236547890123654 | Master Card      | May     |    2022 | 2425 |
